...
var c = canvas.getContext("2d"); // canvas sizes
...
var Player = /*#__PURE__*/function () {
  ...
  _createClass(Player, [{
    ...
    value: function update() {
      ...
      this.position.y += this.velocity.y; // tọa độ + chiều cao + vận tốc.
      ...
      } else {// *Bỏ phần này để vận tốc tiếp tục tăng, thì sẽ có hiệu ứng player bị nhảy xuống hố luôn.
        // this.velocity.y = 0;
      }
    }
  }]);
...
var animate = function animate() {
  window.requestAnimationFrame(animate); // c.clearRect(0, 0, canvas.width, canvas.height);
